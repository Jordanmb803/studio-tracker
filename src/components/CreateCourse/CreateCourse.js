            ...
            <div className='createCourse'>
                ...
                <div className='newInfo'>
                    <div className='textFieldsDiv'>
                        <input className='newInfoInput' id='title' placeholder='Class Number' onChange={e => this.setState({ classNumber: e.target.value })} />
                        <input className='newInfoInput' id='num' placeholder='Class Title'  onChange={e => this.setState({ classTitle: e.target.value })} />
                    </div>
                ...
                <button className='updateButton' onClick={() => this.createCourse()}>Create New Class</button>
                </div>
            </div>
        )
    }
